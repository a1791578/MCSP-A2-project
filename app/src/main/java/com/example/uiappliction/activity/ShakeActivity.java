...
public class ShakeActivity extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //viewArButton = findViewById(R.id.view_ar_button);
        // 初始化菜单列表
        ...
        viewArButton.setOnClickListener(v -> {
            if (randomMenuItem != null) {
                launchModelSelectionActivity(randomMenuItem);
            } else {
                Toast.makeText(this, "Please shake to get a random item first", Toast.LENGTH_SHORT).show();
            }
        });
         */
    }
